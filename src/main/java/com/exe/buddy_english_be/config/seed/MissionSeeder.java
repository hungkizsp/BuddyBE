...
public class MissionSeeder {
    ...
    public void seed() {
        missionRepository.saveAll(List.of(
                Mission.builder().title("Daily Talker").description("Speak 5 sentences to Bolly").missionFrequency(MissionFrequency.DAILY).targetType(TargetType.SPEAK_TIMES).targetValue(5).rewardCoin(10).rewardXp(15).build(),
