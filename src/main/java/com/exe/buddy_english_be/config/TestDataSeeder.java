...
public class TestDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        ScenarioStep step1 = ScenarioStep.builder()
                ...
                .expectedIntent("MAKE_FOOD")
                .expectedEntity("EGG_ON_TOAST")
        ...
        step1 = scenarioStepRepository.save(step1);
        ScenarioStep step2 = ScenarioStep.builder()
                .scenario(breakfastTrouble)
                .stepOrder(2)
                .buddyMessage("Thank you! I'm still thirsty. Can I have some milk?")
                .expectedIntent("GIVE_ITEM")
                .expectedEntity("MILK")
                .successResponse("Yummy! Milk is my favorite drink. Not only does it taste good, but it's also good for my bones!")
                .failResponse("Oops! That's not milk.")
                .build();

        step2 = scenarioStepRepository.save(step2);
        ScenarioStep step3 = ScenarioStep.builder()
                ...
                .failResponse("I asked for an apple.")
                .build();

        step3 = scenarioStepRepository.save(step3);
        ScenarioStep step4 = ScenarioStep.builder()
                ...
                .expectedEntity(null)
                .successResponse("Mission Complete! Great job!")
                .failResponse(null)
                .build();

        step4 = scenarioStepRepository.save(step4);
